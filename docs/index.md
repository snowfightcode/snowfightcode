...
Check out the latest [League Results](league.md) to see how all the bots are performing!
...
- [SnowBot API Documentation (Japanese)](https://github.com/snowfightcode/snowfightcode/blob/main/docs/SnowBotAPI-JP.md)
- [Game Rules](https://github.com/snowfightcode/snowfightcode#readme)
